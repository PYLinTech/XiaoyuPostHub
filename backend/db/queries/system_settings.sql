...
UPDATE system_settings SET
    ...
    pickup_length=sqlc.arg(pickup_length),
    pickup_case_sensitive=sqlc.arg(pickup_case_sensitive),
    pickup_include_letters=sqlc.arg(pickup_include_letters),
    pickup_include_numbers=sqlc.arg(pickup_include_numbers),
    pickup_max_lifetime_seconds=sqlc.narg(pickup_max_lifetime_seconds),
    login_totp_enabled=sqlc.arg(login_totp_enabled),
